...
typedef struct playerlist {
	int id; //yadam bashad bad az akharin player id ro -1 konam
	char name[50]; //esme bazikon
	int skill;
	int fitness;
	int form;
	int position; //mogheiyati k bazikon bazi mikonad 6=darvaze ban, 2=defa, 3=hafbak,4=hamle
...
typedef struct teamlist
{
	...
	PLAYER reserved_player[11]; //zakhire
